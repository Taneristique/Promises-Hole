...
third.addEventListener("click",()=>{if(third.innerHTML==="You are really lucky,dude;)"){location.replace("https://en.wikipedia.org/wiki/List_of_lucky_symbols#/media/File:BIEDRONA.JPG")} else if(third.innerHTML==="bad luck!"){location.replace("unfortunate.html")}})
